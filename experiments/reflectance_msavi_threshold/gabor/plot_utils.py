...
def gabor_segmentation_mask(images, frequencies = [0.1, 0.5], angles = [0, np.pi/2]):
    all_segmented_image, all_image_thresh = gabor_segmentation(images, frequencies, angles)
...
def soil_removed_gray_and_local_eq_gabor_mask(soil_removed_gray):
    """This is the main function which is called by `gabor_texture` module."""
    # Zurguudaa hist equalization hiine.
