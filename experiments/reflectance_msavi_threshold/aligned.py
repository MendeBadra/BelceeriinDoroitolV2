...
if __name__ == "__main__":
    # Directory paths
    root_dir = Path("/media/razydave/CenAppMath/Baasanjargal_Khustai_analysis/Best_img_ref")
    aligned_root_dir = Path("Best_img_aligned"
    "")
    ...
    for category_dir in tqdm(root_dir.iterdir(), desc="Processing categories"):
        if category_dir.is_dir():
            ...
            for fplan_dir in tqdm(category_dir.iterdir(), desc=f"Processing FPLANS in {category_dir}", leave=False):
                if fplan_dir.is_dir():
